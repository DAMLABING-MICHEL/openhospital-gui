...
import org.isf.malnutrition.gui.MalnutritionVisitEdit;
...
//	private boolean isMalnutrition = false;
	...
	private JPanel getPatientDataPanel(){
		...
		JPanel patientCompleteSummary = ps.getPatientCompleteSummary();
		patientCompleteSummary.setPreferredSize(new Dimension(400, 550));
		patientData.add(patientCompleteSummary, BorderLayout.WEST);
		JPanel tablesPanel = getTablesPanel();
		tablesPanel.setPreferredSize(new Dimension(800, 550));
		patientData.add(tablesPanel, BorderLayout.EAST);
...
//							int choice = JOptionPane.showConfirmDialog(PatientDataBrowser.this,
//									MessageBundle.getMessage("angal.malnutrition.admissionnotmarkedasmalnutrition"),
//									MessageBundle.getMessage("angal.malnutrition.confirm"),
//									JOptionPane.OK_CANCEL_OPTION,
//									JOptionPane.WARNING_MESSAGE);
//							if (choice == JOptionPane.OK_OPTION) {
//								new MalnutritionVisitEdit(PatientDataBrowser.this, ad);
//							}
//						}
						new MalnutritionVisitEdit(PatientDataBrowser.this, ad);
						//TODO: when saving the malnutrition row, set also the admission to M
//						}
//						else {
