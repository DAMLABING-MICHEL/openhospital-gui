...
//			private Object Object;
	...
	private JPanel getButtonPanel() {
		JPanel buttonPanel; 
			...
			//buttonPanel.add(getOpdForm(), null);
			buttonPanel.add(getOpdForm(), null);
			buttonPanel.add(getAdmissionForm(), null);
			buttonPanel.add(getDischargeChartButton(), null);
			buttonPanel.add(getLaunchReportButton(), null);
			buttonPanel.add(getCloseButton(), null);
		return buttonPanel;
	}
	
//	private JButton getOpdForm() {
//		if (admissionForm == null) {
//			admissionForm = new JButton();
//			admissionForm.setMnemonic(KeyEvent.VK_P);
//			admissionForm.setText("Admission Forms");
//			admissionForm.addActionListener(new ActionListener() {
//				public void actionPerformed(ActionEvent e) {
//					if (admTable.getSelectedRow() < 0) {
//						JOptionPane.showMessageDialog(PatientFolderBrowser.this, MessageBundle.getMessage("angal.admission.pleaseselectanadmission"),
...
//						new GenericReportPatient(ad.getPatId(), "admission_prescriptions");
//					} else {
//						JOptionPane.showMessageDialog(PatientFolderBrowser.this, 
//								MessageBundle.getMessage("angal.admission.pleaseselectanadmission"),
...
//	}
	...
	private JButton getOpdForm() {
		if (opdForm == null) {
			opdForm = new JButton();
			opdForm.setMnemonic(KeyEvent.VK_O);
			opdForm.setText("OPD Forms");
			opdForm.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					new GenericReportPatient(patient.getCode(), CardPrinter.CARD_FILE, false, false);
				}
			});
		}
		return opdForm;
	...
	private JButton getAdmissionForm() {
		if (admissionForm == null) {
			admissionForm = new JButton();
			admissionForm.setMnemonic(KeyEvent.VK_P);
			admissionForm.setText("Admission Forms");
			admissionForm.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (selectedObj instanceof Admission) {
						...
						Admission ad = (Admission) sorter.getValueAt(selectedRow, -1);
						new GenericReportPatient(ad.getPatId(), CardPrinter.ADMISSION_FILE, false, false);
					} else {
						JOptionPane.showMessageDialog(PatientFolderBrowser.this, 
								MessageBundle.getMessage("angal.admission.pleaseselectanadmission"),
								MessageBundle.getMessage("angal.hospital"), 
	...
	private JButton getDischargeChartButton() {
		if (dischargeChartButton == null) {
			dischargeChartButton = new JButton();
			dischargeChartButton.setMnemonic(KeyEvent.VK_D);
			dischargeChartButton.setText("Admission/Discharge Chart");
			dischargeChartButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (admTable.getSelectedRow() < 0) {
						JOptionPane.showMessageDialog(PatientFolderBrowser.this, MessageBundle.getMessage("angal.admission.pleaseselectanadmission"),
								MessageBundle.getMessage("angal.hospital"), JOptionPane.PLAIN_MESSAGE);
					...
					if (selectedObj instanceof Admission) {
						...
						Admission ad = (Admission) sorter.getValueAt(selectedRow, -1);
						new GenericReportDischargePatient(ad.getId(), ad.getPatId(), GeneralData.DISCHARGECHART);
					} else {
						JOptionPane.showMessageDialog(PatientFolderBrowser.this, MessageBundle.getMessage("angal.admission.pleaseselectanadmission"),
								MessageBundle.getMessage("angal.hospital"), JOptionPane.PLAIN_MESSAGE);
						return;
		...
		return dischargeChartButton;
	}



	private JButton launchReportButton = null;
	private JButton dischargeChartButton = null;
	private JButton admissionForm = null;
	private JButton opdForm = null;
		...
		if (launchReportButton == null) {
			...
			launchReportButton.addActionListener(new ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					new GenericReportPatient(patient.getCode(), GeneralData.PATIENTSHEET, false, false);
				}
			});
		}
