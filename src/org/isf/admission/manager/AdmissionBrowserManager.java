...
public class AdmissionBrowserManager {
	...
	public boolean isPatientCurrentlyAdmitted(Patient patient){
		try {
			return ioOperations.isPatientCurrentlyAdmitted(patient);
		} catch (OHException e) {
	 ...
	 * @return
	 */
	public ArrayList<AdmittedPatient> getAdmittedPatients(String searchTerms, String malnutrition) {
		try {
			return ioOperations.getAdmittedPatients(searchTerms, malnutrition);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	public ArrayList<Admission> getDischarges(GregorianCalendar from, GregorianCalendar to) throws OHException {
		try {
			return ioOperations.getDischarges(from, to);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	/**
	 * Returns the next prog in the year for the hospital in-patients.
	 * @return the next prog or <code>null</code> if the operation fails.
	 */
	public int getNextYProg(){
		try {
			return ioOperations.getNextYProg(null);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return 1;
		}
	 ...
	 */
	public Admission getNextAdmissions(Opd opd) {
		try {
			return ioOperations.getNextAdmissions(opd);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	 ...
	 */
	public Admission getNextAdmissions(Admission adm) {
		try {
			return ioOperations.getNextAdmissions(adm);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
