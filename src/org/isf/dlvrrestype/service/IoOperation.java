...
public class IoOperation {
	...
	public static void main(String[] args) throws OHException {
		DeliveryResultType dis= new DeliveryResultType(MessageBundle.getMessage("angal.dlvrrestype.mx"),MessageBundle.getMessage("angal.dlvrrestype.malattiemodificato"));
		IoOperation io = new IoOperation();
		io.newDeliveryResultType(dis);
		io.updateDeliveryResultType(dis);
	}
