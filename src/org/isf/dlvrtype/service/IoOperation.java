...
public class IoOperation {
	...
	public static void main(String[] args) throws OHException {
		DeliveryType dis= new DeliveryType(MessageBundle.getMessage("angal.dlvrtype.mx"),MessageBundle.getMessage("angal.dlvrtype.malattiemodificato"));
		IoOperation io = new IoOperation();
		io.newDeliveryType(dis);
		io.updateDeliveryType(dis);
	}
