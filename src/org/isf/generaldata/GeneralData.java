 ...
 * 30/06/2012 - Martin	 - added attribute PREGNANCYCARE to enable/disable the module
 -------------------------------------------*/
...
public class GeneralData {
	...
	public static String DISCHARGECHART;
	...
	public static boolean WARDIPDNUMBER;
	...
	public static boolean FORCEDISEASECODE;
	public static boolean AUTOMATICOPD;
	public static boolean AUTOMATICBILL;
	...
	public static boolean PREGNANCYCARE;
	...
	private static String DEFAULT_DISCHARGECHART = "patient_discharge_chart_ver1";
	...
	private static boolean DEFAULT_WARDIPDNUMBER = true;
	...
	private static boolean DEFAULT_FORCEDISEASECODE = false;
	private static boolean DEFAULT_AUTOMATICOPD = false;
	private static boolean DEFAULT_AUTOMATICBILL = false;
	...
	private static boolean DEFAULT_PREGNANCYCARE = true;
	...
	private GeneralData() {
		try {
			...
			DISCHARGECHART = myGetProperty("DISCHARGECHART", DEFAULT_DISCHARGECHART);
			...
			WARDIPDNUMBER = myGetProperty("WARDIPDNUMBER", DEFAULT_WARDIPDNUMBER);
			...
			FORCEDISEASECODE = myGetProperty("FORCEDISEASECODE", DEFAULT_FORCEDISEASECODE);
			AUTOMATICOPD = myGetProperty("AUTOMATICOPD", DEFAULT_AUTOMATICOPD);
			AUTOMATICBILL = myGetProperty("AUTOMATICBILL", DEFAULT_AUTOMATICBILL);
			...
			PREGNANCYCARE = myGetProperty("PREGNANCYCARE", DEFAULT_PREGNANCYCARE);
