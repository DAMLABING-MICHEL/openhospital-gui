...
public class TxtPrinter {
    ...
    private static int DEFAULT_CHAR_HEIGHT = 10;
    private static int DEFAULT_CHAR_WIDTH = 10;
    ...
    private TxtPrinter() {
    	try	{
			...
			CHAR_HEIGHT = myGetProperty("CHAR_HEIGHT", DEFAULT_CHAR_HEIGHT);
			CHAR_WIDTH = myGetProperty("CHAR_WIDTH", DEFAULT_CHAR_WIDTH);
