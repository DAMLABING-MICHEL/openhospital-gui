...
public class IoOperations {
	...
	protected Movement toMovement(ResultSet resultSet) throws SQLException {
		MedicalType medicalType = new MedicalType(resultSet.getString("MDSRT_ID_A"), resultSet.getString("MDSRT_DESC"));
		Medical medical = new Medical(resultSet.getInt("MDSR_ID"), medicalType, resultSet.getString("MDSR_CODE"), resultSet.getString("MDSR_DESC"), 0, 0, 0, 0, 0, 0);
		...
		Lot lot = toLot(resultSet);
		Movement movement = new Movement(medical, movementType, ward, lot, toCalendar(resultSet.getTimestamp("MMV_DATE").getTime()), resultSet.getInt("MMV_QTY"), resultSet.getString("MMV_FROM"), resultSet.getString("MMV_REFNO"));
