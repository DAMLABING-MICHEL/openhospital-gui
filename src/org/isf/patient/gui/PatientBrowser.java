...
public class PatientBrowser extends ModalJFrame implements PatientListener{
	...
	private JButton getJNewButton() {
		if (jNewButton == null) {
			...
			jNewButton.setText(MessageBundle.getMessage("angal.patient.new"));
	...
	private JButton getJEditButton() {
		if (jEditButton == null) {
			...
			jEditButton.setText(MessageBundle.getMessage("angal.patient.edit"));
				...
				public void actionPerformed(ActionEvent event) {
					if (jTable.getSelectedRow() < 0) {
						JOptionPane.showMessageDialog(null,
								MessageBundle.getMessage("angal.patient.pleaseselectarow"),
								MessageBundle.getMessage("angal.patient.stlukehospital"),
	...
	private JButton getJCloseButton() {
		if (jCloseButton == null) {
			...
			jCloseButton.setText(MessageBundle.getMessage("angal.patient.close"));
	...
	private JButton getJDeteleButton() {
		if (jDeteleButton == null) {
			...
			jDeteleButton.setText(MessageBundle.getMessage("angal.patient.delete"));
				...
				public void actionPerformed(ActionEvent event) {
					if (jTable.getSelectedRow() < 0) {
						...
						int n = JOptionPane.showConfirmDialog(null,
								...
								MessageBundle.getMessage("angal.patient.stlukehospital"), JOptionPane.YES_NO_OPTION);
