...
public class PricesOthersEdit extends JDialog {
	...
	private JButton getJButtonCancel() {
		if (jButtonCancel == null) {
			...
			jButtonCancel.setText(MessageBundle.getMessage("angal.pricesothers.cancel")); //$NON-NLS-1$
	...
	private JButton getJButtonOK() {
		if (jButtonOK == null) {
			...
			jButtonOK.setText(MessageBundle.getMessage("angal.pricesothers.okm")); //$NON-NLS-1$
