...
import org.isf.sms.service.IoOperations;
...
public class SmsBrowser extends ModalJFrame {
	...
	private static Logger logger = LoggerFactory.getLogger(SmsBrowser.class);
	...
	private IoOperations smsOp = new IoOperations();
						...
						if (n == JOptionPane.YES_OPTION) {
							for (int i : indexes) {
								...
								try {
									...
									logger.error("==> OHEXEPTION : " + e1.getMessage());
								}
							}
						}
						updateModel(dateFrom, dateTo);
