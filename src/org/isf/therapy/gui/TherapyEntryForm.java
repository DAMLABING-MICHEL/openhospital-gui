...
//							newStartingDate(theChooser.getDate());
	...
	private JButton getButtonCancel() {
		if (buttonCancel == null) {
			buttonCancel = new JButton(MessageBundle.getMessage("angal.therapy.cancel")); //$NON-NLS-1$
	...
	private JButton getButtonOK() {
		if (buttonOK == null) {
			buttonOK = new JButton(MessageBundle.getMessage("angal.therapy.okm")); //$NON-NLS-1$
