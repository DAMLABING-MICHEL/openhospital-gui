...
public class WardBrowser extends ModalJFrame implements WardEdit.WardListener {
	...
	private String[] pColums = { MessageBundle.getMessage("angal.ward.code"),
			...
			"MinAge",
			"MaxAge"};
	private int[] pColumwidth = {45, 80, 60, 60, 80, 30, 30, 30, 30, 30, 30, 15, 15};
	private Class[] pColumnClass = {String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, Boolean.class, Boolean.class, Boolean.class, Integer.class, Integer.class};
	...
	public WardBrowser() {
		...
		if(!manager.maternityControl()) {
			manager.newWard(ward=new Ward("M","MATERNITY","234/52544","54324/5424","maternity@stluke.org",20,3,2,0,0,0));
		}
		initialize();
		setVisible(true);
	}
	...
	private JButton getJNewButton() {
		if (jNewButton == null) {
			...
			jNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent event) {
					ward=new Ward(null,"","","","",null,null,null,0,0,0);;	//operation will reference the new record
	...
	private JTable getJTable() {
		if (table == null) {
			...
			table.getColumnModel().getColumn(8).setPreferredWidth(pColumwidth[11]);
			table.getColumnModel().getColumn(8).setPreferredWidth(pColumwidth[12]);
	...
	class WardBrowserModel extends DefaultTableModel {
		...
		public Object getValueAt(int r, int c) {
			...
			if (c == 0) {
				...
				return ward.getMinimumMonths();
			} else if (c == 12) {
				return ward.getMaximumMonths();
			}
			return null;
		}
