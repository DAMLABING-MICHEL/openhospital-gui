...
public class WardEdit extends JDialog {
	...
	private JLabel minAgeLabel = null;
	...
	private JTextField minAgeTextField = null;
	private JTextField maxAgeTextField = null;
	private JCheckBox isPharmacyCheck = null;
	private JCheckBox isFemaleCheck = null;
	private JCheckBox isFreeCheck = null;
	...
	private JPanel getDataPanel() {
		if (dataPanel == null) {
			...
			gbc_isFemaleCheck.gridy = 9;
			dataPanel.add(getIsFemaleCheck(), gbc_isFemaleCheck);
			GridBagConstraints gbc_isFreeCheck = new GridBagConstraints();
			gbc_isFreeCheck.anchor = GridBagConstraints.WEST;
			gbc_isFreeCheck.insets = new Insets(0, 0, 5, 0);
			gbc_isFreeCheck.gridwidth = 2;
			gbc_isFreeCheck.gridx = 0;
			gbc_isFreeCheck.gridy = 10;
			dataPanel.add(getIsFreeCheck(), gbc_isFreeCheck);
			minAgeLabel = new JLabel();
			minAgeLabel.setText("Minimum Age");
			GridBagConstraints gbc_minAgeLabel = new GridBagConstraints();
			gbc_minAgeLabel.anchor = GridBagConstraints.WEST;
			gbc_minAgeLabel.insets = new Insets(0, 0, 5, 5);
			gbc_minAgeLabel.gridx = 0;
			gbc_minAgeLabel.gridy = 11;
			dataPanel.add(minAgeLabel, gbc_minAgeLabel);
			GridBagConstraints gbc_minAgeTextField = new GridBagConstraints();
			gbc_minAgeTextField.fill = GridBagConstraints.HORIZONTAL;
			gbc_minAgeTextField.insets = new Insets(0, 0, 5, 0);
			gbc_minAgeTextField.gridx = 1;
			gbc_minAgeTextField.gridy = 11;
			dataPanel.add(getMinAgeTextField(), gbc_minAgeTextField);
			maxAgeLabel = new JLabel();
			maxAgeLabel.setText("Maximum Age");
			...
			gbc_maxAgeLabel.gridy = 12;
			dataPanel.add(maxAgeLabel, gbc_maxAgeLabel);
			GridBagConstraints gbc_maxAgeTextField = new GridBagConstraints();
			gbc_maxAgeTextField.fill = GridBagConstraints.HORIZONTAL;
			gbc_maxAgeTextField.insets = new Insets(0, 0, 5, 0);
			gbc_maxAgeTextField.gridx = 1;
			gbc_maxAgeTextField.gridy = 12;
			dataPanel.add(getMaxAgeTextField(), gbc_maxAgeTextField);
			...
			okButton.addActionListener(new ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try {
						...
						JOptionPane.showMessageDialog(WardEdit.this, "Please insert a valid minimum age");
						return;
					}
					try {
						maxAge = Integer.parseInt(maxAgeTextField.getText());
					} catch (NumberFormatException f) {
						JOptionPane.showMessageDialog(WardEdit.this, "Please insert a valid maximum age");
						return;
					}
					if (beds<0) {
					...
					ward.setFree(isFreeCheck.isSelected());
					ward.setMinAge(minAge);
					ward.setMaxAge(maxAge);
...
//				lastdescription=ward.getDescription();
	 ...
	 * @return javax.swing.JTextField	
	 */
	private JTextField getMinAgeTextField() {
		if (minAgeTextField == null) {
			minAgeTextField = new VoLimitedTextField(4, 20);
			if (!insert) {
				minAgeTextField.setText(Integer.toString(ward.getMinimumMonths()));
			}
		}
	 ...
	 * @return javax.swing.JTextField	
	 */
	private JTextField getMaxAgeTextField() {
		if (maxAgeTextField == null) {
			maxAgeTextField = new VoLimitedTextField(4, 20);
			if (!insert) {
				maxAgeTextField.setText(Integer.toString(ward.getMaximumMonths()));
			}
		}
	...
	/**
	 * This method initializes isFreeCheck
	 * 
	 * @return javax.swing.JCheckBox
	 */
	private JCheckBox getIsFreeCheck() {
		if (isFreeCheck==null) {
			isFreeCheck = new JCheckBox("Free of Charge");
			if (!insert) {
				isFreeCheck.setSelected(ward.isFree());
			}
		}
		return isFreeCheck;
	}
